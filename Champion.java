...
public class Champion 
{
	...
	{
		/*
		//Damage done by autoattack if the target has 0 or more armor.
		if(target.armor >= 0)
		{
			target.hp = target.hp - ((100 / (100 / target.armor)) * atkDmg);
		}
		//Damage done by autoattack if the target has less than 0 armor.
		else
		{
			target.hp = target.hp - ((2-(100 / (100 - target.armor))) * atkDmg);
		}
		*/
